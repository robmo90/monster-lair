...
import de.enduni.monsterlair.encounters.monsters.domain.*
import de.enduni.monsterlair.encounters.monsters.view.adapter.MonsterForEncounterViewHolder
import de.enduni.monsterlair.encounters.monsters.view.adapter.MonsterViewHolder
...
class EncounterCreatorViewModel(
    ...
    fun start(numberOfPlayers: Int, levelOfEncounter: Int, targetDifficulty: EncounterDifficulty) {
        encounter = Encounter(
    ...
    override fun onIncrement(monsterId: Int) {
        encounter.incrementCount(monsterId)
        postCurrentState()
    }

    override fun onDecrement(monsterId: Int) {
